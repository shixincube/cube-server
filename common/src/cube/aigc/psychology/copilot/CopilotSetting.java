...
//                .append("。").append(this.speechStyle.description).append("\n");
    ...
    public JSONObject toJSON() {
        ...
        // 兼容
        json.put("personalityTrait", "Random");
        json.put("attachmentType", "Random");
        json.put("culturalBackground", "Random");
        json.put("chiefComplaintType", "Random");
        json.put("painLevel", "Random");
        json.put("defenseMechanism", "Random");
        json.put("empathy", "Random");
        json.put("speechStyle", "Random");
        json.put("hiddenAgendaModel", "Random");
        json.put("multipleRolesModel", "Random");
        json.put("ethicalTrapModel", "Random");
