package cube.service.tokenizer.viterbi;

import cube.service.tokenizer.CharacterUtil;
import cube.service.tokenizer.Log;
import cube.service.tokenizer.Node;
import cube.service.tokenizer.Pair;
...
public class FinalSeg {
    ...
    private static final String PROB_EMIT = "assets/tokenizer/prob_emit.txt";
    ...
    private void loadModel() {
        ...
        InputStream is = null;
        try {
            is = new FileInputStream(new File(PROB_EMIT));
