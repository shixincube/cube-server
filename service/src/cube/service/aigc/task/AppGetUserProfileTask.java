 ...
 * 获取用户心图数据任务。
 */
public class AppGetUserProfileTask extends ServiceTask {

    public AppGetUserProfileTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
