 ...
 * 获取知识库进度任务。
 */
public class GetKnowledgeProgressTask extends ServiceTask {

    public GetKnowledgeProgressTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
    ...
    public void run() {
        ...
        KnowledgeProgress progress = base.getProgress();
        if (null == progress) {
            this.cellet.speak(this.talkContext,
