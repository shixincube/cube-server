 ...
 * 查询咨询策略。
 */
public class QueryCounselingStrategyTask extends ServiceTask {

    public QueryCounselingStrategyTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
    ...
    public void run() {
        ...
        try {
            ...
            CounselingStrategy result = CounselingManager.getInstance().queryCounselingStrategy(authToken,
                    theme, attribute, streamName);
            if (null == result) {
                this.cellet.speak(this.talkContext,
