 ...
 * 应用版本信息任务。
 */
public class AppVersionTask extends ServiceTask {

    public AppVersionTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
    ...
    public void run() {
        ...
        JSONObject data = service.getStorage().getAppVersion();
        if (null == data) {
            this.cellet.speak(this.talkContext,
