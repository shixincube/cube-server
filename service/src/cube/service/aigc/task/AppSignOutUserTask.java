 ...
 * 注销用户任务。
 */
public class AppSignOutUserTask extends ServiceTask {

    public AppSignOutUserTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
    ...
    public void run() {
        ...
        // 注销用户
        User user = service.signOutUser(ContactManager.getInstance().getContact(token.getDomain(), token.getContactId()));
        this.cellet.speak(this.talkContext,
