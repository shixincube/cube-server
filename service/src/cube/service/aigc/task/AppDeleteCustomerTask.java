 ...
 * 删除客户数据任务。
 */
public class AppDeleteCustomerTask extends ServiceTask {

    public AppDeleteCustomerTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
    ...
    public void run() {
        ...
        try {
            ...
            Customer customer = PsychologyScene.getInstance().getStorage().readCustomer(user.getContactId(), id);
            if (null == customer) {
                this.cellet.speak(this.talkContext,
