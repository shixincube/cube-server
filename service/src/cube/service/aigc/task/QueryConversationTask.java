...
public class QueryConversationTask extends ServiceTask {
    ...
    public QueryConversationTask(Cellet cellet, TalkContext talkContext, Primitive primitive, ResponseTime responseTime) {
    ...
    public void run() {
        ...
        AIGCConversationResponse response = null;
        try {
