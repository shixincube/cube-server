...
public class ShowIndicatorSubtask extends ConversationSubtask {

    public final static String RECENT_ONE = "最近一份";

    public ShowIndicatorSubtask(AIGCService service, AIGCChannel channel, String query, ComplexContext context,
                ...
                this.service.getExecutor().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        record.answer = String.format(Resource.getInstance().getCorpus(CORPUS,
                                ...
                                ReportHelper.makeContentMarkdown(report, false, 10, false));
                        convCtx.record(record);
                        listener.onGenerated(channel, record);
                        channel.setProcessing(false);
