...
public class TeenagerProblemClassificationNode extends StrategyNode  {
    ...
    public TeenagerProblemClassificationNode(String query, QueryRevolver revolver, PaintingReport report) {
    ...
    public String perform(GeneratingRecord input) {
        if (input.answer.contains("不是")) {
            Logger.d(this.getClass(), "#perform - No teenager query: " + this.query);
            return null;
        }
