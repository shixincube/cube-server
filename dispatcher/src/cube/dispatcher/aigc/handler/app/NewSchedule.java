...
public class NewSchedule extends ContextHandler {

    public NewSchedule() {
        super("/app/schedule/new/");
    ...
    private class Handler extends AIGCHandler {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response) {
            ...
            try {
                ...
                JSONObject responseData = Manager.getInstance().syncRequest(token, AIGCAction.AppNewSchedule, requestData);
