...
public class DeleteSchedule extends ContextHandler {

    public DeleteSchedule() {
        super("/app/schedule/delete/");
    ...
    private class Handler extends AIGCHandler {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response) {
            ...
            try {
                ...
                JSONObject responseData = Manager.getInstance().syncRequest(token, AIGCAction.AppDeleteSchedule, requestData);
